...
set "SCRIPT_DIR=%~dp0"
set "PS1_SCRIPT=%SCRIPT_DIR%docker-build.ps1"
...
echo PowerShell was not found in PATH. Install PowerShell or run scripts\docker-build.sh from Git Bash/WSL. 1>&2
exit /b 1